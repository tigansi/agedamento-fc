        ...
        <div id="card">
          ...
          <form action="" method="post" id="f-cad-med" autocomplete="off">
            <div class="form-group">
              ...
              <input placeholder="Insira o nome do profissional" class="form-control" type="text" id="nome" required />
              <p id="info_nome" class="text-danger"></p>
            </div>
            <div class="form-group">
              <label for="">E-mail</label>
              <input placeholder="exemplo@dominio.com.br" class="form-control" type="email" id="email" required />
              <p id="info_email" class="text-danger"></p>
            </div>
            <div class="form-group">
              <label for="">Senha</label>
              <input placeholder="Escolha sua senha forte e segura" class="form-control" type="password" id="senha" required />
